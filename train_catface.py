...
parser.add_argument("--lr_step", default=100)
...
if __name__ == "__main__":
    ...
    # 加载数据
    dataset = datasets.ImageFolder(r"img/train/catface",
    ...
    # 设置动态学习率
    scheduler_g = lr_scheduler.StepLR(optimize_g, step_size=opt.lr_step, gamma=0.9)
    scheduler_d = lr_scheduler.StepLR(optimize_d, step_size=opt.lr_step, gamma=0.9)
